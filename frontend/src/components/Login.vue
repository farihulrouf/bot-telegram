    ...
    <div class="bg-[#dfa674] rounded-2xl flex max-w-3xl p-5 items-center">
      <div class="md:w-1/2 px-8">
        ...
        <form @submit.prevent="handleLogin" class="flex flex-col gap-4">
          <input v-model="email" class="p-2 mt-8 rounded-xl border" type="email" placeholder="Email">
          <div class="relative">
            <input v-model="password" :type="passwordVisible ? 'text' : 'password'" class="p-2 rounded-xl border w-full" placeholder="Password">
        ...
        <!-- Other elements like Google login, forget password, register button can be included similarly -->
      </div>
